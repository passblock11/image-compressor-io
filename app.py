...
def compress(file: UploadFile = File(...)):
    ...
    try:
        # file size validation using stream seek
        file.file.seek(0, 2)
    ...
    # convert RGBA/LA before resize for better performance
    ...
    # convert other modes after resize
    if img.mode != "RGB":
        img = img.convert("RGB")
    ...
    # return compressed image content from buffer
    return Response(
