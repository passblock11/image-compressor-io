...
def compress(file: UploadFile = File(...)):
    ...
    try:
        # file size validation using seek/tell to avoid reading large files into memory
        file.file.seek(0, 2)
    ...
    if width > MAX_WIDTH:
        ...
        # BICUBIC is faster than LANCZOS with minimal quality loss
    ...
    # getvalue() is more efficient than read() after seek(0)
    return Response(
