...
async def compress(file: UploadFile = File(...)):
    ...
    try:
        # file size validation using seek/tell to avoid reading whole file into memory
        file.file.seek(0, 2)
    ...
    if width > MAX_WIDTH:
        ...
        # Use BICUBIC instead of LANCZOS for a better balance of speed and image quality.
